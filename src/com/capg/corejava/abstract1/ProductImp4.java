...
// performing initialization to instance variables of abstract class by the value passed by user, while 
...
public class ProductImp4 extends Product4 {
	...
	public static void main(String[] args) {
		...
		// reference creation
		//-----------------------
		// setting values to abstract class instance variables by calli g super() method inside Child class 
