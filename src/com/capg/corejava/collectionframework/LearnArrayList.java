...
public class LearnArrayList {
	...
	public static void main(String[] args) {
		...
		// different ways to iterate or print
		...
		list.set(2, 1000); // replace and set new element at an index number

		System.out.println(list);

		System.out.println(list.contains(500)); // boolean and returns true if available else false
